                        ...
                        <div id="edit-row" class="row justify-content-center align-items-center">
                            <div id="edit-icolumn" class="col-md-6">
                                <div id="logn-box" class="col-md-12">
                                    ...
                                    <form id="edit-form" class="form" action="" method="post">
                                        <h3 class="text-center text-info">Article Data</h3>
                                        <div class="form-group">
                                            <label for="username" class="text-info">Article Name</label><br>
                                        ...
                                        <div id="register-link" class="text-right">
                                            <a href="" class="text-info"><input type="submit" name="submit" class="btn btn-info btn-md" value="submit"></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
