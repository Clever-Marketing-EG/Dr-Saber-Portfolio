...
<footer class="new-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 section-two">
                <h6 class="footer-title">information</h6>
                <div class="row mb">
                    <div class="col-md-6 icon-container"> <i class="fa fa-phone" style="margin-top: 5px;margin-left: -5px;"></i></div>
                    <span class="col-md-6">01224745749</span>
                </div>
                <div class="row mb">
                    <div class="col-md-6 icon-container"> <i class="fa fa-envelope" style="margin-top: 5px;margin-left: -6px;"></i></div>
                    <span class="col-md-6">example@example.com</span>
                </div>
                <div class="row mb">
                    <div class="col-md-6 icon-container"> <i class="fa fa-map-marker" style="margin-top: 5px;margin-left: -4px;"></i></div>
                    <span class="col-md-6">example@example.com</span>
                </div>
...
<div class="footer-bottom">
    <!-- Container -->
    <div class="container">
        <p>&copy;2021 All Rights Reserved. Designed by <a class="clever" href="https://clevermarketing-eg.com/">Clever
                marketing.</a></p>
    </div><!-- Container /- -->
</div>
